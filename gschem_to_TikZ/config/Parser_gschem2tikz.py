...
"""
g2t = Parser_gschem2tikz('config_default.ini')

print(g2t.get_color(0))
print(g2t.get_alignment(0))
print(g2t.get_attribute_main_shown('refdes'))
print(g2t.get_attribute_child_shown('refdes'))
print(g2t.get_thickness_main('inner sep'))
print(g2t.get_thickness_child('inner sep'))
"""
